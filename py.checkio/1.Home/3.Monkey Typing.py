...
a part of other word. Text letter case does not matter. Words are given in 
...
Input: Two arguments. A text as a string (unicode for py2) and words as a set of 
strings (unicode for py2).
